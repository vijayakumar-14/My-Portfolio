...
const expensePhotos = [expense2, expense3, expense4, expense6, expense7, expense8];
          ...
          <div className="p-6 overflow-y-auto max-h-[55vh]">
            ...
            {tab === "links" && (
              <div className="space-y-3">
                ...
                <a
                  href="https://drive.google.com/uc?export=download&id=1YBjXD-YHMncYbXrQ8Lyt2bcqgWKIBazx"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-between gap-3 bg-muted hover:bg-muted/70 border border-border rounded-xl p-4 transition-colors"
                >
